<template>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <h1>
            ...
            <!-- <span style="color: #f1c544;font-size: 24px;margin-left: 20px;">基于改进的ssd农作物病虫害识别系统</span> -->
          </h1>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div href="javascript:void(0);" @click="showConsole" class="ml-lg-3 mt-lg-0 mt-3 book btn btn-style">数据中心
            </div>
          </div>
        </nav>
      </div>
  ...
  <el-carousel class="carousel" trigger="click" interval="3900" height="960px" :pause-on-hover="false"
    indicator-position="none" arrow="never" autoplay>
    <div class="text_title">
      <div class="text_title_cn">AI农作物病虫害识别预警系统</div>
      <div class="text_title_en">AI intelligent identification and early warning system of crop diseases and insect pests.
      </div>
    </div>
    <el-carousel-item>
      <div class="img-box img-box1">
        <img class="roll-img" src="/src/assets/img/roll_image1.jpg">
      </div>
    </el-carousel-item>
    <el-carousel-item>
      <div class="img-box img-box2">
        <img class="roll-img" src="/src/assets/img/roll_image2.jpg">
      </div>
    </el-carousel-item>
    <el-carousel-item>
      <div class="img-box img-box2">
        <img class="roll-img" src="/src/assets/img/roll_image3.jpg">
      </div>
    </el-carousel-item>
  </el-carousel>
        ...
        <div class="grids">
          <div class="grids-content row text-center">
            ...
            <div class="column col-lg-4 col-md-6 col-sm-6 back-image editContent p-sm-0">
              <img src="/src/assets/img/5.jpg" alt="product" class="img-responsive rounded-0">
            </div>

            <div class="column col-lg-4 col-md-6 col-sm-6 color-2 editContent">
              <div>
                <h4><a href="javascript:void(0);" class=" editContent">预警防范 农作物病虫害系列</a></h4>
                <p class="para editContent">人们通常把为害各种植物的昆虫和螨类等称为害虫，把由它们引起的各种植物伤害称为虫害。虫害的特点是为害速度快，损失程度重，防控难度大。</p>
              </div>
            </div>
            <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 editContent p-sm-0">
              <img src="/src/assets/img/6.jpg" alt="product" class="img-responsive rounded-0 ">
            </div>
            <div class="column col-lg-4 col-md-6 col-sm-6 color-2 editContent">
              <div>
                <h4><a href="javascript:void(0);" class=" editContent">AI世界 图像上传智能识别</a></h4>
                <p class="para editContent">图像识别是人工智能的一个重要领域，是指利用计算机对图像进行处理、分析和理解，以识别各种不同模式的目标和对像的技术。</p>
              </div>
            </div>
            <div class="column col-lg-4 col-md-6 col-sm-6 back-image editContent p-sm-0">
              <img src="/src/assets/img/7.jpg" alt="product" class="img-responsive rounded-0">
            </div>
            <div class="column col-lg-4 col-md-6 col-sm-6 color-2 editContent">
              <div>
                <h4><a href="javascript:void(0);" class=" editContent">数据中心 病虫害数据</a></h4>
                <p class="para editContent">调整和改善作物的生长环境，以增强作物对病、虫、草害的抵抗力，创造不利于病原物、害虫和杂草生长发育或传播的条件，以控制、避免或减轻病、虫、草的危害。</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="w3l-teams-15">
    <div class="team-single-main editContent">
      <div class="container echartsBox">
        <!-- <div class="row">
        ...
        <div class="row">
          <div class="column2 image-text col-xl-6" style="color: #fff;">
            <h3 class="team-head editContent">农作物病虫害危害</h3>
            <div class="team-two">
              ...
              <div class="nature-row">
                ...
                <p class="para editContent text ">
                  &nbsp;&nbsp;&nbsp;&nbsp;人们所常说的农作物、从广义上讲是指凡具有经济价值而被人们栽培的植物，具体来讲是指具有经济价值，被人们种植在大田中的植物，俗称庄稼，包括粮、棉、油、麻、糖、茶、烟等。农作物从播种、生长至收获，经常受到各种有害生物(植物病原、害虫、杂草和害鼠等)的为害，从而影响栽培植物的产量和质量，由于有害生物的种类繁多，形态各异，发生规律各有不同，因此，认识有害生物，掌握有害生物的习性、特点，对防控有害生物极其重要。
                </p>
              </div>
            </div>
          </div>
          <div class="column2 image-text col-xl-6">
            <img src="/src/assets/img/b1.jpg" alt="product" class="img-responsive ">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="covers-main editContent">
      <div class="container">
        <div class="gallery-image row">
          <div class="img-box column color-2 editContentc col-lg-4 ">


            <h5 class="my-2"><a style="font-size: 26px;" href="http://www.gov.cn/xinwen/2021-03/31/content_5596907.htm"
                target="_blank">农业农村部部署农作物重大病虫害防控
                <br />
                <br />
                <p class="para">当前，春耕生产从南到北陆续展开，春季田管进入关键时期，小麦
                  条锈病等防控即将进入重要时段。农业农村部副部长张桃林在30日举行的全国农作物重大病虫害防控工作
                  视频会上介绍，受气候条件和境外虫源入侵等因素影响，今年农作物病虫害呈加重发生态势。根据全国农作
                  物病虫害测报网监测和专家会商分析，预计今年小
                  麦、水稻、玉米等粮食作物重大病虫呈加重发生态势，发生面积21亿亩次，同比增加14%，对粮食生产构成直接威胁。</p>
              </a>
            </h5>

            <!-- <h4 class=" editContent">农业农村部部署农作物重大病虫害防控</h4>
            <p class="para">---</p>
            <h5>  <a class="aaaa" href="http://www.gov.cn/xinwen/2021-03/31/content_5596907.htm" target="_blank">
              <p class="para">当前，春耕生产从南到北陆续展开，春季田管进入关键时期，小麦
                条锈病等防控即将进入重要时段。农业农村部副部长张桃林在30日举行的全国农作物重大病虫害防控工作
                视频会上介绍，受气候条件和境外虫源入侵等因素影响，今年农作物病虫害呈加重发生态势。根据全国农作
                物病虫害测报网监测和专家会商分析，预计今年小
          ...
          <div class="img-box col-lg-4 col-md-6">
            <img src="/src/assets/img/8.jpg" alt="product" class="img-responsive ">
            <h5 class="my-2"><a href="http://www.chinapesticide.org.cn/yqnq/22244.jhtml"
                target="_blank">2022年全国农作物重大病虫害发生趋势预报
                <p class="para">---</p>
                <p class="para" style="font-weight: normal">近期，全国农技中心组织科研、教学和推广单位专家，对2022年全国农作物重大病虫害发生趋势进行分析会商 ....</p>
              </a></h5>

          </div>
          <div class="img-box col-lg-4 col-md-6">
            <img src="/src/assets/img/9.jpg" alt="product" class="img-responsive">
            <h5 class="my-2"><a href="http://www.zghcfzw.com/news/list.asp?news_id=880"
                target="_blank">中国害虫防治理网全球十大杀虫剂市场与展望
                <p class="para">---</p>
                <p class="para" style="font-weight: normal">在全球农药市场中，杀虫剂占了28%的市场份额，2011年销售额达到了140亿美元。
                  在这些杀虫剂中，销售额排在前10位的品种....</p>
              </a>
    ...
    <div class="main-w3">
      <div class="container" style="display:flex;justify-content: center;align-content: center;">
        <div style="text-align: center;">
          <div style="color:#fff;font-size: 32px;margin-bottom: 50px;">农作物病虫害知识科普</div>
          <div style="position: relative;">
            <input v-model="searchValue" placeholder="请输入作物名或病虫草害名关键词（例如：褐斑病）"
              style="padding: 15px 50px;width:900px;text-align: center;font-size: 22px;color:#495057;" />
            <div @click="search" style="position:absolute;color:#fff;width:67px;height: 67px;line-height: 67px;
            text-align: center;background-color: #f1c544;border-radius: 6px;right: -67px;top: 0;">
              搜索
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row footer-top-29">
          <div class="col-lg-5 col-md-5 col-sm-6 footer-list-29 footer-1">
            <div class="left-side">
              <h2><a href="javascript:void(0);" class="footer-logo">岁 稔 年 丰</a></h2>
              <p class="para">农民，是站在历史的肩头，从土地中寻求闪光的太阳；</p>
              <br />
              <p class="para">劳动一日,可得一夜的安眠，勤劳一生,可得幸福的长眠。</p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 footer-list-29 footer-3">
            ...
            <div class="footer-post mb-3">
              <!-- <a href="javascript:void(0);">
                <img src="/src/assets/img/f1.jpg" class="img-responsive" alt="">
              </a> -->
              <div>
            ...
            <div class="footer-post">
              <!-- <a href="javascript:void(0);">
                <img src="/src/assets/img/f2.jpg" class="img-responsive" alt="">
              </a> -->
              <div>
  ...
  <!-- <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class=" bottom-copies text-center">
        <p class="copy-footer-29">© 2020 睿农. All rights reserved | Designed by <a
...
const showConsole = () => {
  router.push("/consoleHome")
}

const searchValue = ref("")
const search = () => {
  window.open(`http://cloud.sinoverse.cn/index_bch-list.html?k=${searchValue.value}`);
}
...
onMounted(() => {
  ...
  function scrollFunction() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
      let movetop = document.getElementById("movetop"); if (movetop === null) { return } movetop.style.display = "block";
    } else {
      let movetop = document.getElementById("movetop"); if (movetop === null) { return } movetop.style.display = "none";
    }
  }
})
...
.w3l-inner-banner-main .main-titles-head {
...
.w3l-inner-banner-main .breadcrumbs-sub {
...
.w3l-top-menu-4 .address ul li a,
.w3l-top-menu-4 .address ul li p {
...
.w3l-top-menu-4 .address ul li a:hover {
...
.w3l-top-menu-4 a.search-search {
  background: #fff;
  padding: 8px 8px;
  border-radius: 4px;
  font-size: 14px;
  ...
  color: #28a745;
  display: inline-block;
  border: 1.5px solid #f1c544;
}

.w3l-top-menu-4 a.search-search:hover {
  background: #28a745 !important;
  color: #fff !important;
  border: 1.5px solid #28a745 !important;
}

.w3l-top-menu-4 .popup .close {
  position: absolute;
  right: 0px;
  top: -50px;
...
.w3l-top-menu-4 .popup .close:hover {
  opacity: 1;
}

.w3l-top-menu-4 .search-here {
  grid-template-columns: 1fr 1fr 1fr 1fr;
  display: grid;
  grid-gap: 15px;
}

.w3l-top-menu-4 .search-below {
  display: grid;
...
.w3l-top-menu-4 select.form-control {
  outline: none;
  width: 100%;
  font-size: 16px;
  min-height: 52px;
...
.w3l-top-menu-4 .search-container input {
...
.w3l-top-menu-4 .search-container input:hover {
  border: 2px solid #f1c544;
  background: #f1c544 !important;
}
...
.w3l-top-menu-4 .book-form select {
  background: #fff url(../images/down.png) no-repeat 90% 52%;
}

.w3l-top-menu-4 .popup h3 {
...
@media (max-width: 667px) {
  .w3l-top-menu-4 .address:nth-child(1) {
    display: none;
  }
...
@media (max-width: 440px) {
  .w3l-top-menu-4 .address:nth-child(2) {
    display: none;
  }
...
@media (max-width: 991px) {
  ...
  .w3l-header-4 .navbar-light .navbar-toggler span.fa {
    font-size: 24px;
    margin-top: -4px;
  }

  .w3l-header-4 .navbar-light .navbar-toggler {
...
.w3l-main-slider .owl-theme .owl-nav [class*=owl-]:hover {
...
.w3l-main-slider .owl-theme .owl-nav [class*=owl-]:focus,
.w3l-main-slider .owl-theme:focus,
.w3l-main-slider .owl-dots:focus,
.w3l-main-slider .owl-dot:focus {
  outline: none;
  box-shadow: none;
}
...
.w3l-teams-15 .team-single-main {
  padding: 130px 0px;
  background: url(../../assets/img/3.jpg) no-repeat center;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.w3l-teams-15 .team-single-main:before {
  width: 100%;
  content: "";
...
.w3l-teams-15 .nature-row:nth-child(2) {
  margin-top: 15px;
}

.w3l-teams-15 .nature-row h5 a {
  font-size: 22px;
  line-height: 32px;
  color: var(--logo-color);
  display: inline-block;
...
.w3l-teams-15 .nature-row h5 a:hover {
  color: #f1c544;
}
...
@media screen and (max-width: 767px) {
  .w3l-covers-18 .img-box:nth-child(3) {
    margin-top: 34px;
  }
}
...
.w3l-specification-6 h3.title-big a {
  color: var(--header-title-color);
  line-height: 45px;
  font-size: 35px;
  display: inline-block;
...
.w3l-specification-6 .grids-1 a span.fa {
  color: #28a745;
  font-size: 40px;
  margin-bottom: 20px;
  opacity: 0.5;
...
.w3l-specification-6 h3.title-big a:hover {
  color: #28a745;
}
...
@media (max-width: 991px) {
  ...
  .w3l-specification-6 .grids-effect-2:nth-child(6),
  .w3l-specification-6 .grids-effect-2:nth-child(4),
  .w3l-specification-6 .grids-effect-2:nth-child(5) {
    margin-top: 30px;
  }
...
.w3l-clients .hh14-text h5 {
  font-size: 18px;
  line-height: 30px;
  color: #c3c3c3;
}

.w3l-clients .hh14-text {
  background: #fff;
  padding: 25px 25px;
  border-radius: 10px;
}

.w3l-clients .client-name {
  display: grid;
...
@media screen and (max-width: 992px) {
  ...
  .w3l-clients .slider-info:nth-child(3) {
    margin-top: 20px;
  }
}

@media (max-width: 767px) {
  .w3l-clients .slider-info:nth-child(2) {
    margin-top: 20px;
  }
}

@media (max-width: 440px) {
  .w3l-clients .w3l-clients .main-w3 {
    padding: 80px 0;
  }
}
...
.w3l-recent-work .progress {
  height: .3rem;
}

.w3l-recent-work .my-bar-grids h4 {
  font-size: 17px;
  line-height: 25px;
...
.w3l-recent-work .my-bar-grids {
  margin: 0px 0px 15px;
}

.w3l-recent-work .my-bar-grids h4 span {
  float: right;
  font-size: 0.9em;
  font-weight: 600;
}
...
.w3l-content-with-photo-4 .hair-left h5 a:hover {
  color: #28a745;
}
...
@media (max-width: 800px) {
  ...
  .w3l-content-with-photo-4 span.para {
    display: none;
  }
}
...
@media all and (max-width: 414px) {
  .w3l-content-with-photo-4 .hair-two-colums {
    grid-template-columns: 1fr;
  }
}
...
.w3l-about .counter-width:before {
  content: "";
...
.w3l-team-main-6 .our-team .team-content .name a {
  font-size: 22px;
  line-height: 25px;
  color: #fff;
  letter-spacing: 1px;
...
.w3l-team-main-6 .our-team .team-content .post a {
  font-size: 17px;
  display: block;
  color: var(--logo-color);
  transition: all 0.3s ease 0s;
...
.w3l-team-main-6 .social-teams a {
  color: #fff;
  width: 30px;
  height: 30px;
  line-height: 30px;
...
.w3l-team-main-6 .social-teams a.facebook {
  background: #3b5998;
}

.w3l-team-main-6 .social-teams a.twitter {
  background: #1da1f2;
}

.w3l-team-main-6 .social-teams a.pinterest {
  background: #bd081c;
}

.w3l-team-main-6 .social-teams {
  display: flex;
  margin-top: 15px;
  justify-content: center;
}

.w3l-team-main-6 .our-team img {
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
}

.w3l-team-main-6 .our-team:hover {
  opacity: .8;
}
...
@media (max-width: 991px) {
  ...
  .w3l-team-main-6 .team-team:nth-child(3),
  .w3l-team-main-6 .team-team:nth-child(4) {
    margin-top: 30px;
  }
}

@media (max-width: 568px) {
  .w3l-team-main-6 .team-team {
    max-width: 530px;
    margin: 0px auto;
  }

  .w3l-team-main-6 .team-team:nth-child(2) {
    margin-top: 30px;
  }
}
...
.w3l-recent-work-hobbies .about-line-top:nth-child(5),
.w3l-recent-work-hobbies .about-line-top:nth-child(4),
.w3l-recent-work-hobbies .about-line-top:nth-child(6) {
  margin-top: 50px;
}

.w3l-recent-work-hobbies .about-grids h5 a {
  color: var(--para-light-color);
  font-size: 25px;
  line-height: 35px;
  margin-bottom: 10px;
...
.w3l-recent-work-hobbies .about-grids h5 a:hover {
  color: #28a745;
}
...
.w3l-recent-work-hobbies .one-image {
  background: url(../images/5.jpg) no-repeat center;
}

.w3l-recent-work-hobbies .two-image {
  background: url(../images/6.jpg) no-repeat center;
}

.w3l-recent-work-hobbies .three-image {
  background: url(../images/7.jpg) no-repeat center;
}

.w3l-recent-work-hobbies .four-image {
  background: url(../images/8.jpg) no-repeat center;
}

.w3l-recent-work-hobbies .five-image {
  background: url(../images/9.jpg) no-repeat center;
}

.w3l-recent-work-hobbies .six-image {
...
.w3l-recent-work-hobbies .color-white {
...
.w3l-services-two .service-info a h4 {
  font-size: 22px;
  font-weight: 700;
  line-height: 28px;
  margin-bottom: 10px;
...
.w3l-services-two .service-info a h4:hover {
  color: #28a745;
}

.w3l-services-two .service-info {
  padding: 30px 20px;
...
.w3l-contact-info-main .map-content-9 form input,
...
.w3l-contact-info-main .cont-details h6 {
  font-size: 20px;
  line-height: 30px;
  color: var(--header-title-color);
  margin-bottom: 5px;
...
.w3l-contact-info-main .map-content-9 {
...
.btn-secondary.focus {
  ...
  background-color: #eeba20;
  border-color: #edb615;
  box-shadow: 0 0 0 0.2rem rgba(210, 173, 64, 0.5);
}
...
.btn-outline-secondary.focus {
  box-shadow: 0 0 0 0.2rem rgba(241, 197, 68, 0.5);
}
...
.bg-secondary {
  background-color: #f1c544 !important;
}
...
button.bg-secondary:focus {
  background-color: #edb615 !important;
}
...
button.action-button:active {
  color: #f1c544;
  border-bottom: 1.5px solid #f1c544;
  border-radius: 0px;
}

a.action-sub-button:hover,
a.action-sub-button:active {
  background: #28a745;
  color: #fff;
  border: 2px solid #28a745;
}
...
.social span.fa.fa:hover,
.team-para span.fa.fa:hover {
  color: #28a745;
}
