		...
		<div class="bg">
			...
			<div class="host-body">
				...
				<div class="d-flex jc-center title_wrap">
					<div class="link-btns">
						<div class="link-btns-item" @click="jump('/index')">
							<dv-border-box-12>数据大屏</dv-border-box-12>
						</div>
						<div class="link-btns-item" @click="jump('/algorithm')">
							<dv-border-box-12>养分预测</dv-border-box-12>
						</div>
					</div>
					<div class="back-introduce">
						<div class="link-btns-item" @click="jump('/introduce')">
							<dv-border-box-12 class="link-btns-item">返回首页</dv-border-box-12>
						</div>
					...
					<div class="d-flex jc-center">
						<div class="title">
							<span class="title-text">土壤养分预测系统</span>
						</div>
					</div>
					<div class="timers">
